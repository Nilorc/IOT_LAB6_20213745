...
public class Linea1Adapter extends RecyclerView.Adapter<Linea1Adapter.MovimientoViewHolder> {

    private List<MovimientoLinea1> lista;
    private OnItemClickListener listener;

    public interface OnItemClickListener {
        void onEditar(MovimientoLinea1 movimiento);
        void onEliminar(MovimientoLinea1 movimiento);
    }

    public Linea1Adapter(List<MovimientoLinea1> lista, OnItemClickListener listener) {
        this.lista = lista;
    ...
    public void onBindViewHolder(@NonNull MovimientoViewHolder holder, int position) {
        MovimientoLinea1 mov = lista.get(position);
        holder.tvFecha.setText("Fecha: " + mov.getFecha());
        holder.tvEstaciones.setText(mov.getEstacionEntrada() + " → " + mov.getEstacionSalida());
    ...
    public void actualizarLista(List<MovimientoLinea1> nuevaLista) {
