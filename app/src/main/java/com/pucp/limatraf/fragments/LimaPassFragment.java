...
import com.pucp.limatraf.adapters.LimaPassAdapter;
...
public class LimaPassFragment extends Fragment {
    ...
    private void configurarRecyclerView() {
        ...
        adapter = new LimaPassAdapter(new ArrayList<>(), new LimaPassAdapter.OnItemClickListener() {
            @Override
            public void onEditar(MovimientoLimaPass mov) {
                etIdTarjeta.setText(mov.getIdTarjeta());
                etFecha.setText(mov.getFecha());
                etEntrada.setText(mov.getParaderoEntrada());
                etSalida.setText(mov.getParaderoSalida());
                etTiempo.setText(mov.getTiempoViaje());
                btnGuardar.setTag(mov);
            }

            @Override
            public void onEliminar(MovimientoLimaPass mov) {
        ...
        db.collection("movimientos-limapass")
                ...
                .addOnSuccessListener(querySnapshot -> {
                    List<MovimientoLimaPass> lista = new ArrayList<>();
    ...
    private void filtrarMovimientos() {
        ...
        db.collection("movimientos-limapass")
                ...
                .addOnSuccessListener(snapshot -> {
                    List<MovimientoLimaPass> filtrados = new ArrayList<>();
    ...
    private void guardarMovimiento() {
        ...
        MovimientoLimaPass movEditando = (MovimientoLimaPass) btnGuardar.getTag();

        Map<String, Object> movimiento = new HashMap<>();
        movimiento.put("idTarjeta", idTarjeta);
        movimiento.put("fecha", fecha);
        movimiento.put("paraderoEntrada", entrada);
        movimiento.put("paraderoSalida", salida);
